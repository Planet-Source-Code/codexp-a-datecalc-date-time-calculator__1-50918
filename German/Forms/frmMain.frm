...
Begin VB.Form frmMain 
   ...
   Caption         =   "DATUM-RECHNER  -  (C)2003 by CodeXP"
   ClientHeight    =   3480
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5520
   ...
   Begin VB.Frame fraRechopt 
      ...
      Begin VB.CheckBox chkSetDate 
         Caption         =   "Ergebnis als Datum benutzen"
         Height          =   255
         Left            =   240
         TabIndex        =   23
         Top             =   2640
      ...
      Begin VB.OptionButton optRO 
         ...
         Style           =   1  'Grafisch
         TabIndex        =   21
         ToolTipText     =   " Differenz (Datum - Datum = Interval) "
         Top             =   1680
         Width           =   495
      End
      Begin VB.OptionButton optRO 
         ...
         Style           =   1  'Grafisch
         TabIndex        =   20
         ToolTipText     =   " Subtraktion (Datum - Interval = Datum) "
         Top             =   1680
         Width           =   375
      End
      Begin VB.OptionButton optRO 
         ...
         Style           =   1  'Grafisch
         TabIndex        =   19
         ToolTipText     =   " Addition (Datum + Interval = Datum) "
         Top             =   1680
         Value           =   -1  'True
         Width           =   375
      End
...
Private Sub cmdAbout_Click()
  Dim sTxt As String
  sTxt = "DATUM RECHNER (C)2003 by CodeXP" & vbCrLf & _
         "Coder: CodeXP" & vbCrLf & _
         "E-Mail: CodeXP@Lycos.de" & vbCrLf & _
         "Language: German" & vbCrLf & _
...
Private Sub cmdCalc_Click()
  ...
  Case 9 ' s    - Sekunde        '
    sInt = "s"
  Case Else
    MsgBox "Wählen Sie zuerst das Interval aus!", vbExclamation
    Exit Sub
  End Select
...
Calc_Error:
  txtErg = ""
  MsgBox "Fehler! Überprüfen Sie die Eingaben!", vbCritical
End Sub
...
Private Sub Form_Load()
  ...
  ' Intervale füllen              '
  lstInt.AddItem "Jahr"
  lstInt.AddItem "Quartal"
  lstInt.AddItem "Monat"
  lstInt.AddItem "Tag des Jahres"
  lstInt.AddItem "Tag"
  lstInt.AddItem "Wochentag"
  lstInt.AddItem "Woche"
  lstInt.AddItem "Stunde"
  lstInt.AddItem "Minute"
  lstInt.AddItem "Sekunde"
  lstInt.ListIndex = 0
End Sub
...
Private Sub txtDate_ValidationCheck()
  ...
  If Err Then
    txtDate = nTxt
    MsgBox "Eingegebenes Datum ist fehlerhaft!", vbCritical
  Else
    txtDate = nDat
  End If
End Sub
